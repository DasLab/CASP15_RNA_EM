...
# Results
###############################################################################
# you will find combined results in all*csv
...
metrics = {'angle_outlier': 'min', 'avg_suitness': 'max',
           'suite_outlier': 'min', 'bond_outlier': 'min', 'clashscore': 'min',
           'pucker_outlier': 'min', 'rmsd_lga': 'min', 'gdt_ts': 'max',
...
# for each metric and target, calculate Z-scores
