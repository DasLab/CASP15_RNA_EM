...
if __name__ == '__main__':
    ...
    argParser.add_argument('--usalign_exec', type=str, help="")
    argParser.add_argument('--chimerax_exec', type=str, help="")
    ...
    if args.EM:
        score_all_from_file(file=args.file, out_file_prefix=args.out_file_prefix, native=args.native,
                            usalign_exec=args.usalign_exec, chimerax_exec=args.chimerax_exec, EM=args.EM, emmap=args.emmap,
                            resolution=args.resolution, threshold=args.threshold, phenix_location=args.phenix_location)
    else:
        score_all_from_file(file=args.file, out_file_prefix=args.out_file_prefix, native=args.native,
                            usalign_exec=args.usalign_exec, EM=args.EM, phenix_location=args.phenix_location)
